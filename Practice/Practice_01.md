...
2. Show how to create directories for the course, first lab, and the first problem from the terminal. Show how to list files and directories, how to move around the file system.
3. Show how to create a simple “hello, world” program in C with nano.
4. Explain the compilation process for the C language.
5. Demonstrate fundamental compilation steps with gcc (preprocessing, assembly code generation).
7. Demonstrate the differences between optimized and unoptimized assembly generated by the compiler.
6. Demonstrate the final machine code for the `main` function with objdump and less. Explain the role of the linker.
